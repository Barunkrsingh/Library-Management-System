            ...
            <div class="container">
                <div class="row">
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li class="active"><a href="../qr/index.php"><i class="menu-icon icon-home"></i> Attendance
                                </a></li>
                    ...
                    <div class="span9">
                        ...
                        <a href="addstaff.php" class="btn btn-primary">Add Library staff</a>
                ...
                <div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2024 LMS Login. </b>All rights reserved. Barun | Pravalesh | Danish | Priyanka | Prachi | Nikita
